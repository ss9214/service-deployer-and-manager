...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "${var.platform_name}-public-subnet-${count.index + 1}"
    Type = "public"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "${var.platform_name}-private-subnet-${count.index + 1}"
    Type = "private"
  }
}
...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name = "${var.platform_name}-nat-eip"
  }
}
